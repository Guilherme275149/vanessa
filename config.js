const ownerNumber = ["557598943332@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '557598943332' 
...
const menumsgimg = (numero, groupname, battery) => {
    return `MENU DA VANESSA  COM 434 COMANDOS, BATERIA: ${battery}`
}
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=557598943332:+55 75 9894-3332\n' 
+ 'END:VCARD'
